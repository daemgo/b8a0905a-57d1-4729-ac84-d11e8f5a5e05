---
name: init-project
description: 基于用户的一句话提示词初始化 楔子科技 项目，提取项目/方案名称、客户名称等信息，并根据意图自动调用相应的 skill（profile、plan-writer、init-app）
metadata:
...
这个 skill 用于基于用户的一句话提示词，智能解析并初始化 楔子科技 项目。它会提取关键信息（项目名称、方案名称、客户名称等），并根据用户意图自动调用相应的 skill。
